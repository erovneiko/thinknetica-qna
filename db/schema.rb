...
ActiveRecord::Schema.define(version: 2021_12_28_094622) do
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["subscriptable_type", "subscriptable_id", "user_id"], name: "index_subscription_user"
    t.index ["subscriptable_type", "subscriptable_id"], name: "index_subscriptions_on_subscriptable"
    t.index ["user_id", "subscriptable_type", "subscriptable_id"], name: "index_user_subscription"
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "votable_type", "votable_id"], name: "index_votes_on_user_id_and_votable_type_and_votable_id"
